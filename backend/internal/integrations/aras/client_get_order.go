...
//
// Aras imzası: GetOrderWithIntegrationCode(integrationCode, userName, password) — auth lowercase
// olarak top-level parametre. UserName/Password içte tekrar gönderilmiyor.
